...
<div class="grid_3">
  <div class="container">
   ...
   <div class="navigation" style="background-color: #A9A9A9;"><!-- Innernavigation starts -->
		        ...
		        <ul class="nav navbar-nav nav_1">
		    		...
		    		<li class="dropdown">
		              ...
		              <ul class="dropdown-menu" role="menu">
		               <li><a href="delete_profile.php?id=<?php echo $id;?>">Delete Profile</a></li>
...
<div>Let's find your right adventure partner and get lost into adventures!!</div>
<div style="padding-top: 200px;"></div>
