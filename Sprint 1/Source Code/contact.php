...
<div class="grid_3">
  <div class="container">
   ...
   <div class="grid_5">
      <p>Our team makes sure your queries are answered within 24 hours and well assist you.</p>
      <address class="addr row">
        <dl class="grid_4">
            <dt>Address :</dt>
            <dd>
                1716 Terill Mill Road, <br>
                MArietta, GA 30067.
            </dd>
        </dl>
        <dl class="grid_4">
        ...
        <dl class="grid_4">
            <dt>E-mail :</dt>
            <dd><a href="mailto:letsadventure@gmail.com">mail(at)Let's-adventure</a></dd>
        </dl>
      </address>
    </div>
   </div>
