...
<div class="grid_3">
 ...
 Date Of Birth <span class="form-required" title="This field is required.">*</span></label>
			...
			<div class="form-group col-sm-6">
		      <label for="edit-activity">Activities<span name="activities" class="form-required" title="This field is required.">*</span></label>
			...
			<div class="form-group col-sm-6">
		      <label for="edit-place">Places You Want to Visit<span name="placetovisit" class="form-required" title="This field is required.">*</span></label>
